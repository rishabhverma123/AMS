...
<body>
	<div>
		...
		if(isset($_POST['submit'])&& isset($_POST['hod-choose-option']) && isset($_POST['hod-choose-semester']))
		{	
			$option=$_POST['hod-choose-option'];
		...
		function student_detail()
		{
			...
			{
				//selecting name from name-roll table with the help of rollnumber generated from student-detail table
