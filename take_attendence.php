		...
		<div>
			...
			<form id ="create"	class="navbar-form navbar-left" action="<?php echo $_SERVER['PHP_SELF']?>"	method ="POST" onsubmit="return parent.scrollTo(0,1500); return true" >
			  <div
				...
				<button class="btn btn-default" type="submit" name="submit_sem" value="SELECT">Submit
				</button>
			</form>
			...
			<div class="container-fluid">
			  <div class="row" style="height:30%;">
				...
				<div class="col-sm-9 col-lg-10" style="height:250%;overflow:auto;" id="result">
					<h3 align="center">Take Attendence</h3>
					<div id="form1">
						<form action="<?php $_SERVER['PHP_SELF']?>" method="POST" class="form-horizontal">
							...
							<option value="select"> --SELECT--</option>
								...
								<?php
									/*
									*----------------------------------------------------------------------------------
									*After selecting semester from navigation bar
									*Fill subject-code field by matching from faculty detail and selected semester
									*----------------------------------------------------------------------------------
									*/
							...
							<button class="btn btn-default" type="submit" name ="submit_attendance" value ="submit">Submit</button>
						</form>
						...
						<?php
							...
							{	
								...
								$query_attendence="SELECT * FROM `date_subject` WHERE `date`='".$date."' AND `subject_code`='".$subject_code."-".$batch."'";
								$query_run_attendence=mysqli_query($connection,$query_attendence);
								$num_rows_class=mysqli_num_rows($query_run_attendence);	
								...
								{
									header('Location:attendence_form.php');
								}			
							}
						?>
					  </div>
