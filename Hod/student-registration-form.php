...
$current_semester=$_SESSION['registration_semester'];
			...
			if(isset($_POST['submit-student-registration']))
			{
				...
				if(!empty($rollnumber) &&!empty($name) &&!empty($phone_number) &&!empty($email) &&!empty($current_semester) &&!empty($guardian_ph_no))
				{
					$query_1="INSERT INTO `name-roll` (rollnumber,name) VALUES ('".$rollnumber."','".$name."')";
					$result=mysqli_query($connection,$query_1);

				
					$query_2="INSERT INTO `student-detail` (rollnumber,phonenumber,email,guardianphone,current_semester) VALUES ('".$rollnumber."','".$phone_number."','".$email."','".$guardian_ph_no."','".$current_semester."')";
			 ...
			 <div id="form1">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" class="form-horizontal">
					...
					<div id="form-group">
						...
						<div class="col-sm-8">
							<input	type='text'	pattern='[789][0-9]{9}'	name='phone_number'	class="form-control"	required>
							<br/>
						</div>
					</div>
					<div id="form-group">
					...
					<div id="form-group"> 
						<label id="remark1" class="control-label col-sm-4">&nbsp;SEMESTER:</label>
						<div class="col-sm-8">
							<input type='text' name='current_semester' class="form-control" required placeholder="1"> <br/>
						</div>
					</div>
							<br/><br/><button class="btn btn-default" type="submit" name ='submit-student-registration' value ="submit">Submit </button>
