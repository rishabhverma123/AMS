...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-inverse" style="margin-bottom:0px;padding-left:0px;padding-top:0px;">
			...
			<div class="container-fluid">
			  ...
			  <?php
				...
				{	
					...
					//This function old_attendence() is now not in used and was used
					//previously in hod options to display attendance.
					//It is now not called anywhere.
			...
			<?php include("inclusior-faculty-registration-form.html")?>
		</div>
	</body>
</html>
